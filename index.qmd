...
::: {.notes}
There are nine participants in this cohort of the OSC Incubator Programme including myself and as stated the aim is to
seed, nurture and help grow Open Science/Scholarship Communities around the world.
...
forth and should work with existing groups such as the FAIR Roadmap Working Group.
:::
...
+ Establish a forum.
+ Reuse of material and knowledge from existing OSCs.
:::
...
+ Few other UK Universities have established OSCs
+ Others on current Incubator Programme
+ Opportunity to help lead development of OSC UK
+ Present if not launch around OpenFest2023

::: {.notes}
Currently there are no established OSC groups at UK Universities, although there are others on the Incubator course that
I'm running at the moment, from memory there is a lady at Durham University, Fuschia [Surname], who used to work here at
the University of Sheffield.

This gives us an opportunity to be a prominent exponent of Open Science Communities in the UK as funders rethink their
policies to promote greater transparency and journals are adopting pre-registration and adopting transparency policies
around data, materials and code.

Not currently seeking any costing for this work its something I've undetaken of my own volition as I'm keen to see Open
