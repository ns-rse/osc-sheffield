...
::: {.notes}
Open Science Communities are part of the International Network of Open Science Communities, this started in the
Netherlands at Utrecht but grew organically, spreading to other universities within the Netherlands who came together
under the umbrella of OSC NL but it has grown beyond just one country and there are now local branches in other
...
recently and have been participating in for three weeks now.
:::
...
::: {.notes}
There are nine participants in this cohort of the OSC Incubator Programme including myself with researches from Greece,
Portugal, France and Germany

The stated the aim is to seed, nurture and help grow Open Science/Scholarship Communities around the world.
:::
...
::: {.notes}
As we all know, there are a _lot_ of tools out there these days for undertaking open research, sometimes it can be a
little overwhelming.
:::
...
::: {.notes}
Nurturing a community within Sheffield and as part of the wider INOSC brings together people with shared goals and gives
them a sense of belonging. It allows people to make connections and gives them opportunities to learn and grow, which
encourages and enables them to take action.
:::
...
normalising the practices and when one person teaches two people learn.

Training courses are great for getting started but typically when applying what you've learned to your own
domain/work/problem there will be problems that crop up and this is where the support of a community comes in really
helpful as you know where to look for people who can help.

Having physical meetings is an important key feature, but can be augmented by having online forum of some description
that allows a permanent record of problems solving to be built up and searched and serve as a basis for developing
more formal documentation that needs improving or creating if for example many people meet a problem/barrier when trying
to use a service such as ORDA this could be recognised if there are lots of people asking questions or needing support
on that front.
:::
...
Very often experience is more important than expertise. I speak from experience that knowing a system really well means
that you can often overlook certain aspects that you take for granted and that someone new to a system might struggle to
understand or use. When I started learning to use Git for version control collaboratively my colleagues talked about it
as though I already understood what rebasing was, but it was a completely new concept coming from a situation where I
had only ever used Git on my own.
...
They key to the community really is about participation though and peer-to-peer interactions help promote this.
:::
...
Further regular workshops on different topics would be undertaken allowing people not just to learn about different
...
of more structured and formal documentation such as FAQs on particular topics.

Perhaps one of the most useful aspects of joining the International Network of Open Science Communities is that there
...
+ Opportunity join growing INOSC
...
Sirois](https://www.durham.ac.uk/staff/fuschia-sirois/) from the University of Durham, she also happens to be an alumni
of The University of Sheffield.

Not currently seeking any costing for this work its something I've undertaken of my own volition as I'm keen to see Open
Research be more widely adopted and normalised within the research community as I feel there is still a long way to go
and that building a community of people to support each other is an effective means of normalising the practice and
increasing the open ness of research at The University of Sheffield and beyond.
:::
